            ...
            <div class="grid grid-cols-1 gap-y-12 lg:gap-x-20 lg:grid-cols-2 2xl:gap-x-8 items-center">
                <div>
                    <div class="2xl:max-w-sm">
                        ...
                        <p class="mt-4 text-sm font-medium leading-6 text-gray-500">
                            Sign up to create an account and start using our web app. If you already have an account, you can sign in.
                        </p>

                        <form action="{{route('register.custom')}}" method="POST" class="mt-12">
                            @csrf
                            <div class="space-y-6">
                                <div>
                                    <label for="" class="text-sm font-bold text-gray-900"> Your name </label>
                                    <div class="relative mt-2">
                                        ...
                                        <input type="text" name="name" id="name" placeholder="Your full name" value="" class="border block w-full py-3 pl-12 pr-4 placeholder-gray-500 border-gray-300 rounded-lg focus:ring-green-600 focus:border-green-600 sm:text-sm caret-green-600" />
                                    </div>
                                </div>
                                ...
                                <div>
                                    <div class="flex items-center justify-between">
                                        <label for="" class="text-sm font-bold text-gray-900"> Confirm Password </label>
                                    </div>
                                    <div class="relative mt-2">
                                        <div class="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none">
                                            <svg class="w-5 h-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        ...
                                        <input type="password" name="confirm_password" id="confirm_password" placeholder="Password confirmation" value="" class="border block w-full py-3 pl-12 pr-4 placeholder-gray-500 border-gray-300 rounded-lg focus:ring-green-600 focus:border-green-600 sm:text-sm caret-green-600" />
                                    </div>
                                </div>
                        ...
                        <div class="mt-20">
                            <p class="text-sm font-medium text-gray-900">Have an account? <a href="{{route('login')}}" title="Login" class="font-bold text-green-600 hover:underline">Login</a></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="overflow-hidden text-center bg-gray-100 rounded-2xl">
                    <div class="flex items-center justify-center px-8 py-12 sm:px-12 sm:py-16 md:py-24 md:px-20">
                        <div>
                            <img class="w-auto mx-auto" src="{{asset('media/healthy food-bro.svg')}}" alt="" />
